...
const { createJob, getMyJobs, getAllJobs, getOpenJobs, closeJob } = require('../controllers/jobController');
const { authMiddleware, adminOnly, hrApprovedOnly } = require('../middlewares/authMiddleware');
